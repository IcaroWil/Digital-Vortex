...
const GameDetails = ({gameData}) => {
  ...
  return (
    <GameDetailsWrapper>
      <div className='details-tilte'>
        <h3 className='details-title-text text-white f2-6 text-uppercase'>{ gameData?.
        name }</h3>
      </div>
      <div className='details-grid d-grid'>
        ...
        <div className='details-right'>
          ...
          <div className='para-text' dangerouslySetInnerHTML={{ __html: (gameData?.
          description)?.split('.').splice(0, 3).join('.') + "."}}></div>
          ...
          <ul className='details-list-group'>
            <li className='list-group-item text-white d-flex align-items-center flex-wrap'>
              <div className='item-left d-flex align-items-center'>
                <span className='item-icon d-flex align-items-center justify-content-center me-2'>
