    ...
    <FooterWrapper>
        ...
        <div className='footer-content text-white d-grid container'>
          <div className='footer-item'>
            <a href="#" className='navbar-brand text-white text-uppercase no-wrap d-block'>
              digital <span>vortex</span>
            </a>
            <p className='para-text'>Vincere aut Mori - Ludere Est Vivere</p>
          </div>
          ...
          <div className='footer-item'>
            ...
            <ul className='footer-item-link'>
              <li><a href="#" className='text-white'>Settings & Privacy</a></li>
          ...
          <div className='footer-item'>
            ...
            <p className='para-text'>Subscriber our newsletter to get out latest update & news.</p>
      ...
      <div className='footer-bottom'>
        <div className='container d-flex flex-column text-center'>
          <p className='footer-bottom-text text-green'>Copyright & copy 2024 IcaroWil - All rights reserved.</p>
