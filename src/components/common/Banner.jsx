  ...
  return (
    <BannerWrapper className='d-flex align-items-center justify-content-start' style = {{
      ...
      <div className='banner-content w-100 container text-white'>
        ...
        <p className='lead-text'>Join us for non-stop live gaming action! Experience a wide variety of games and immerse yourself in endless fun. Whether you’re a seasoned gamer or just looking for a casual play, there’s something here for everyone. Dive into our dynamic gaming community and let the adventures begin!</p>
